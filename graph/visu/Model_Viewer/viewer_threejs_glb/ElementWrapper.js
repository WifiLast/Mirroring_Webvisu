var Model_Viewer_GLBElementWrapper;

(function () {
	/* HTML5 control wrapper for Three.js implementation */
	Model_Viewer_GLBElementWrapper = function (idGenerator) {
		console.log("Model_Viewer_GLBElementWrapper (Three.js): Constructor called");
	...
	Model_Viewer_GLBElementWrapper.prototype = {
		initViewer: function () {
			console.log("Model_Viewer_GLBElementWrapper: initViewer called");
			try {
				...
				console.error("Model_Viewer_GLBElementWrapper: Error in initViewer", e);
		...
		loadModel: function (url) {
			...
			loader.load(url, function (gltf) {
				...
				self.domNode.innerHTML += "<br>Error loading model: " + error.message;
