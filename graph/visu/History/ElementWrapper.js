var HistoryElementWrapper;

(function () {
	/* HTML5 control wrapper for Grid.js Table */
	HistoryElementWrapper = function (idGenerator) {
		console.log("HistoryElementWrapper v1.6 - Debug Row Coloring");
	...
	HistoryElementWrapper.prototype = {
		...
		_processAlarms: function (value) {
			...
			try {
				...
				console.error("HistoryElementWrapper._processAlarms: Error parsing", e);
				return null;
			}
	...
	// Explicit export
	window.HistoryElementWrapper = HistoryElementWrapper;
}());